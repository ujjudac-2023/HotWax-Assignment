...
public class Order {
	...
	public String toString() {
		return "Order [orderId=" + orderId + ", orderName=" + orderName + ", placedDate=" + placedDate
				+ ", approvedDate=" + approvedDate + ", statusId=" + statusId + ", partyId=" + partyId
				+ ", currencyUomId=" + currencyUomId + ", productStoreId=" + productStoreId + ", salesChannelEnumId="
				+ salesChannelEnumId + ", grandTotal=" + grandTotal + ", completedDate=" + completedDate
